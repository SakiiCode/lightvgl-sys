...
#define LV_USE_CALENDAR   1
    ...
    #define LV_CALENDAR_WEEK_STARTS_MONDAY 1
        ...
        #define LV_CALENDAR_DEFAULT_DAY_NAMES {"Hé", "Ke", "Sze", "Cs", "Pé", "Szo", "Va"}
    #else
        #define LV_CALENDAR_DEFAULT_DAY_NAMES {"Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"}
    #endif

    #define LV_CALENDAR_DEFAULT_MONTH_NAMES {"Január", "Február", "Március",  "Április", "Május",  "Június", "Július", "Augusztus", "Szeptember", "Október", "November", "December"}
